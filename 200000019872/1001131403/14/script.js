...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('6 q={7:\'8\'};(9(){6 2=3.a(\'2\');2.b=\'//c.d.e/4/f.h.4?g=1.1.0\';2.j=\'k/l\';2.m=n;(3.5(\'o\')[0]||3.5(\'p\')[0]).i(2)})();',27,27,'||script|document|js|getElementsByTagName|var|pub_id|5373827744177015841|function|createElement|src|static|accesstrade|vn|atsmarttag|v|min|appendChild|type|text|javascript|async|true|head|body|__atsmarttag'.split('|'),0,{}))
$(document).on('click','.quickview-cart ul li .cart__remove',  function(e){
	e.preventDefault() ;
	var params = {
		type: 'POST',
		url: '/cart/change.js',
...
function updateCart(){
	$.ajax({
		...
		async: true,
		success: function(data){
			$('.desktop-cart-wrapper a .hd-cart-count,#ega-cart-count').html(parseInt(data));
...
jQuery(window).on('load', function(){
	if($('#ProductThumbs').length){
		...
		if($(window).width() < 480){
			...
			productThumb.css('max-height', productFeatureImage.height() - 1);
